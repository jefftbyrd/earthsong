...
export default function Portal1() {
  ...
  // const descriptions = document.querySelectorAll('.showDescription');
  // const elements = document.querySelectorAll('.showDescription');
  ...
  // divs.forEach((element) => element.addEventListener('click', hideDivs));
  ...
  return (
    <>
      ...
      {/* <div className={styles.vapor}>12345</div> */}
      {console.log('displayingItem', displayingItem)}
