...
const sketch = (p5) => {
  ...
  p5.setup = () => {
    ...
    soundObject = p5.createDiv('Sound1');
    soundObject.addClass(`${styles.soundObject}`);
    soundObject.draggable();
    soundObject.position(400, 400);
    soundObject.mousePressed(p5.play1);
  };
  ...
  p5.draw = () => {
    ...
    // if (p5.mouseIsPressed && d1 < 100) {
    //   p5.bgColor = p5.color(0, 0, 255);
    // } else {
    //   p5.bgColor = p5.color(255, 0, 0);
    // }
  };
